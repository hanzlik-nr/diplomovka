...
// $destinationURL = 'http://webmap.sk:8080/geoserver2112/nitra_students/wms';
$destinationURL = str_replace("/svc/wms-proxy.php?url=","",$req_uri);

// The only domain from which requests are authorized.
$RequestDomain = '000webhostapp.com';
